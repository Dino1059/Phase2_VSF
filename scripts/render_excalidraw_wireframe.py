...
elements = [
    ...
    # Header Controls
    {"id": "hdr_title", "type": "text", "x": 20, "y": 18, "fontSize": 18, "strokeColor": "#1e1e1e", "text": "🤖 DataTrust OS v3.0 — VinGroup Enterprise AI Governance"},
    ...
    {"id": "hdr_user", "type": "text", "x": 1185, "y": 20, "fontSize": 14, "strokeColor": "#9c36b5", "text": "👤 Steward"},
    ...
    {"id": "lbl_sessions", "type": "text", "x": 15, "y": 130, "fontSize": 14, "strokeColor": "#868e96", "text": "ACTIVE SESSIONS"},
    ...
    {"id": "lbl_repos", "type": "text", "x": 15, "y": 390, "fontSize": 14, "strokeColor": "#868e96", "text": "DATASET REPOSITORY"},
    ...
    # Center Chat Stream & HITL Approval Queue
    ...
    # HITL Approval Card (RuleProposalCard)
    ...
    # Right Workspace Panel (Context Dashboard)
