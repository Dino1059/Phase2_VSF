...
def generate_svg():
    with open('/tmp/excalidraw_homepage_elements.json') as f:
        elements = json.load(f)

    svg_parts = [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 950" width="1600" height="950" style="background:#ffffff; font-family:sans-serif;">'
    ]
    ...
    with open("docs/UI_UX_HOMEPAGE_DASHBOARD_V3.svg", "w", encoding="utf-8") as f:
        f.write("\n".join(svg_parts))
    print("SVG generated successfully at docs/UI_UX_HOMEPAGE_DASHBOARD_V3.svg")
