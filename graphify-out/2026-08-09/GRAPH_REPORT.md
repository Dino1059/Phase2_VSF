...
Cohesion: 0.01
Nodes (226): $7, $8, a5(), a7(), aF(), aj(), aq(), ate() (+218 more)
...
### Community 8 - "index-BRVdCVNO.js"
Cohesion: 0.03
Nodes (93): addPostProcessor(), af(), as(), ba(), bl(), Bo(), bs(), ca() (+85 more)

### Community 9 - "o"
Cohesion: 0.03
Nodes (116): $5(), a9(), accessor(), Ad(), aee(), ag(), ak(), AW() (+108 more)

### Community 10 - "index-DZrVSfRD.js"
Cohesion: 0.04
Nodes (60): addPostProcessor(), bs(), ci(), componentDidCatch(), connect(), cs(), ct(), dd() (+52 more)

### Community 11 - "index-DlyLF_Ln.js"
Cohesion: 0.03
Nodes (75): ad(), addPostProcessor(), af(), Br(), bs(), bu(), ca(), clone() (+67 more)

### Community 12 - "index-Bh8v7zJ5.js"
Cohesion: 0.03
Nodes (86): ad(), add(), addPostProcessor(), af(), bl(), bs(), bu(), cn() (+78 more)

### Community 13 - "routes/__init__.py"
Cohesion: 0.05
Nodes (85): FastAPI, execute_endpoint(), execute_transform_endpoint(), list_executions(), Any, get, post, Request (+77 more)
...
Cohesion: 0.04
Nodes (46): ErrorInjector, GroundTruthLabel, Any, BaseModel, DataFrame, Fixed-seed synthetic error injector across 15 fault families and configurable…, ContextBuilder, Any (+38 more)

### Community 16 - "i"
Cohesion: 0.09
Nodes (82): a(), aa(), ae(), as(), b(), bd(), bi(), Bo() (+74 more)

### Community 17 - "index-to5fYhfR.js"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (46): Alert, AlertService, AlertSeverity, Any, BaseModel, Enum, str, Retrieve in-app alerts filtered by severity and/or status. (+38 more)

### Community 20 - "BenchmarkHarness"
Cohesion: 0.06
...
### Community 24 - "n"
Cohesion: 0.09
Nodes (67): a(), addNamespaces(), addResource(), addResourceBundle(), addResources(), ae(), An(), b() (+59 more)

### Community 25 - "i"
Cohesion: 0.07
Nodes (72): aa(), ac(), af(), ao(), ba(), be(), bi(), Bo() (+64 more)

### Community 26 - "i"
Cohesion: 0.08
Nodes (65): aa(), ac(), ao(), at(), ba(), be(), bi(), Bo() (+57 more)
...
Cohesion: 0.08
Nodes (38): ABC, send_chat_message(), BaseModel, Enum, str, StateMachine, WorkflowState, execute_compiled_rules() (+30 more)
...
### Community 35 - "hT"
Cohesion: 0.07
Nodes (22): ao(), cz(), Em(), f1(), fu, gB(), gk(), hT() (+14 more)

### Community 36 - "test_tools.py"
Cohesion: 0.06
...
### Community 38 - "wd"
Cohesion: 0.07
Nodes (55): ar(), Bn(), Br(), Bt(), componentDidCatch(), cr(), deprecate(), dr() (+47 more)
...
### Community 43 - "Be"
Cohesion: 0.05
Nodes (56): $3(), aS(), av(), Be(), bi(), bM(), cf(), Dl() (+48 more)

### Community 44 - "Z"
Cohesion: 0.09
Nodes (41): bl(), Br(), cl(), dl(), Do(), el(), eo(), fl() (+33 more)

### Community 45 - "middleware.py"
Cohesion: 0.06
Nodes (42): BaseHTTPMiddleware, Response, check_role_permission(), check_user_role(), is_public_path(), Enum, Request, str (+34 more)
...
### Community 61 - "y"
Cohesion: 0.11
Nodes (37): addNamespaces(), addResource(), addResources(), changeLanguage(), dir(), emit(), extendTranslation(), extractFromKey() (+29 more)

### Community 62 - "ErrorCode"
Cohesion: 0.16
...
### Community 69 - "wt"
Cohesion: 0.10
Nodes (23): c4(), c7(), dz(), f4(), Hy(), IR(), KF(), m4() (+15 more)
...
### Community 82 - "Kt"
Cohesion: 0.18
Nodes (15): add(), ef(), gf(), hl(), If(), jf(), jl(), kf() (+7 more)
...
### Community 85 - "UnstructuredSource"
Cohesion: 0.12
...
### Community 93 - "pI"
Cohesion: 0.04
Nodes (70): a1(), a4, ac(), ax(), By, Cc(), $d(), Dp() (+62 more)

### Community 94 - "log_antigravity.py"
Cohesion: 0.17
...
### Community 104 - "test_nlp_eval.py"
Cohesion: 0.10
...
### Community 105 - "agent-trace.schema.json"
Cohesion: 0.10
Nodes (18): agent_type, proposal_id, rules, step_index, trace_id, description, timestamp, required (+10 more)

### Community 106 - "vc"
Cohesion: 0.15
Nodes (20): Bc(), ea(), ec(), exists(), fc(), ff(), Ga(), Ic() (+12 more)

### Community 107 - "run_validator"
Cohesion: 0.35
...
### Community 120 - "vc"
Cohesion: 0.15
Nodes (19): Bc(), ca(), ea(), exists(), ff(), Ga(), Ji(), Ka() (+11 more)
...
### Community 123 - "test_integration.py"
Cohesion: 0.26
...
### Community 136 - "AppShell.tsx"
Cohesion: 0.44
Nodes (6): AppShell(), ROLE_OPTIONS, TopBar(), AppState, useAppStore, UserRole

### Community 137 - "fetch_real_public_datasets.py"
Cohesion: 0.22
...
### Community 147 - "ConnectionManager"
Cohesion: 0.38
...
- **Why does `c()` connect `c` to `index-BaGgQfLv.js`, `n`, `has`, `o`, `i`, `index-to5fYhfR.js`, `i`, `i`, `n`, `i`, `i`, `i`, `t`, `i`, `n`, `hT`, `nc`, `Be`, `gu`, `Fn`, `n`, `hu`, `n`, `gu`, `gu`, `wt`, `Z`, `su`, `pI`, `gu`, `vc`, `vc`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `Rn()` connect `t` to `wd`, `c`, `wd`, `wd`, `index-BRVdCVNO.js`, `wd`, `wd`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `W` connect `c` to `index-BaGgQfLv.js`, `n`, `hT`, `wt`, `dl`, `dl`, `dl`, `o`, `has`, `Be`, `Z`, `Z`, `dl`, `su`, `dl`, `pI`?**
